...
"""
   ...
   输入
    |
   卷积 -> BatchNorm -> ReLU -> 卷积 -> BatchNorm
    |                                         |
    -------------------------------------------
    |
   ReLU
  ...
  输出
    ...
    18,34,50,152 四个版本
    ResNet18： 1.8*1e9 FLOPs
    ResNet34： 3.6*1e9 FLOPs
    ResNet50： 3.8*1e9 FLOPs
    ResNet101： 7.6*1e9 FLOPs
    ResNet152： 11.3*1e9 FLOPs
"""
...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, identity_downsample=None, stride=1):
        ...
        self.relu = nn.ReLU()
        self.identity_downsample = identity_downsample  # 用于转换x，方便相加
...
class ResNet(CscModule):  # [3, 4, 6, 3]
...
if __name__ == '__main__':
    ...
    # Assumes CscModule defines these methods
